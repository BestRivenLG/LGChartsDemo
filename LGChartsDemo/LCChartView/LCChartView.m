...
- (void)initData {
    ...
    _backColor = [UIColor yellowColor];
    ...
    _xAxisTextMargin = _orginXAxisMargin = _xArrowsToText = 20;//30
...
//            CGFloat labelDW_y = y - labelDW_h - 5;
            UILabel *labelDW = [[UILabel alloc] initWithFrame:CGRectMake(0,0,50,labelDW_h)];
